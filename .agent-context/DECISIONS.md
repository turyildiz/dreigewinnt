...
- Host project images on Cloudflare; prefer Cloudflare-hosted image URLs/assets for uploaded/media content rather than committing image blobs to the repo.
