    ...
    <div className="flex flex-col gap-8">
      <form action={action} className="flex flex-col gap-5">
        ...
        <Field label="Beschreibung">
          <textarea name="description" rows={6} defaultValue={defaultValues?.description as string ?? ""} className={`${inputClass} resize-none`} />
        </Field>
        ...
        <div className="flex gap-3 pt-2">
          ...
          <Link href="/admin/jobs" className="px-6 py-3 font-bold uppercase text-xs tracking-widest text-on-surface-variant hover:text-primary transition-colors bg-surface-container-low">
            Abbrechen
          </Link>
        </div>
      </form>
